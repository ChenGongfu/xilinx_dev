...
HD_PWD='C:/Users/ChenG/ALL_DATA/github/zynq_exp/fsm_example/vivado/fsm_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_format3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_format3.tcl
