...
HD_PWD='C:/Users/ChenG/ALL_DATA/github/zynq_exp/pl_led/vivado/pl_led/pl_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pl_led.tcl -notrace
