...
HD_PWD='C:/Users/ChenG/ALL_DATA/github/zynq_exp/pl_led/vivado/pl_led/pl_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_led.tcl
